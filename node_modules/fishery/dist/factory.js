...
var Factory = /** @class */ (function () {
    ...
    Factory.prototype.clone = function () {
        ...
        copy._onCreates = __spreadArrays(this._onCreates);
    ...
    Factory.prototype.builder = function (params, options) {
        if (params === void 0) { params = {}; }
        if (options === void 0) { options = {}; }
        return new builder_1.FactoryBuilder(this.generator, this.sequence(), merge_1.merge({}, this._params, params, merge_1.mergeCustomizer), __assign(__assign({}, this._transient), options.transient), __assign(__assign({}, this._associations), options.associations), this._afterBuilds, this._onCreates);
    };
    return Factory;
}());
