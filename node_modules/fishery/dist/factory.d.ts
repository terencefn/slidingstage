import { DeepPartial, GeneratorFn, BuildOptions, GeneratorFnOptions, HookFn, CreateFn } from './types';
...
export declare class Factory<T, I = any> {
    ...
    protected builder(params?: DeepPartial<T>, options?: BuildOptions<T, I>): FactoryBuilder<T, I>;
}
