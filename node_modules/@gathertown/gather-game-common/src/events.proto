...
message SpaceUserInfo {
  ...
  optional Inventory inventory = 16;
}
...
message ServerClientEvent {
  oneof event {
    ...
    MapSetDesks mapSetDesks = 89; // experimental
    ...
    PlayerSetsNonVerbalCue playerSetsNonVerbalCue = 129; // experimental
...
message PlayerSetsNonVerbalCue {
  uint32 encId = 1;
  optional string nonVerbalCue = 2;
}
...
message ClientServerAction {
  ...
  oneof action {
    ...
    SetArbitraryMapData setArbitraryMapData = 99;
    ...
    SetNonVerbalCue setNonVerbalCue = 106;
...
message SetNonVerbalCue {
  optional string nonVerbalCue = 1;
  optional string targetId = 2;
}
...
*/
message SetArbitraryMapData {
  string mapId = 1;
  string dataJson = 2;
  optional bool deleteMap = 3;
}
message HighFive {
  string targetId = 1;
}
