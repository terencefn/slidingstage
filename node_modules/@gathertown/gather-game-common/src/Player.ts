...
export const CONSTANT_PERMANANT_EMOTES = [EMOTE_EMOJIS[Emote.RaisedHand]];

export const keyPressedToEmote = (keycode: number, emotesArray: string[]) => {
  return emotesArray[keycode - 1];
};

export const getAllEmotes = (tempEmotes: string[]) => {
  return [...tempEmotes, ...CONSTANT_PERMANANT_EMOTES];
};
...
export const INVENTORY_MAX_COLUMN = 3;
export const INVENTORY_MAX_ROW = 3;
