...
import { SpaceUserInfo, Space, SpawnPoint, Portal, Announcer, WireArea, SpeakerUpdatesSession, ChatMessageUpdated, SpaceItem, UpdateSubscriptions } from "@gathertown/gather-game-common/dist/src/public/events";
import { EnabledChat, GameMapV2, MapObject, TutorialTasks, WallFloorBlock } from "@gathertown/gather-game-common/dist/src/public/gameMap";
...
declare type GameEventSubscriptions<T extends GameEventCase> = {
    [uuid: string]: {
...
export declare type GameOptions = {
    ...
    subscribeTo?: UpdateSubscriptions["subscriptions"];
};
export declare class Game {
    ...
    setNonVerbalCue(nonVerbalCue: string | undefined, targetId?: string): void;
    ...
    setVehicleId(vehicleId: string, targetId?: string): void;
    ...
    highFive(targetId: string): Promise<void>;
    setArbitraryMapData(mapId: string, dataJson: string, deleteMap?: boolean): Promise<unknown>;
